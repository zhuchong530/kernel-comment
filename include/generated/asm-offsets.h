...
#define TASK_threadsp 11872 /* offsetof(struct task_struct, thread.sp)	# */
#define TASK_stack_canary 2216 /* offsetof(struct task_struct, stack_canary)	# */

#define TASK_TI_flags 0 /* offsetof(struct task_struct, thread_info.flags)	# */
#define TASK_addr_limit 12008 /* offsetof(struct task_struct, thread.addr_limit)	# */
