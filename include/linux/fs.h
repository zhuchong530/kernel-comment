...
struct inode {
	...
	struct super_block	*i_sb;			   /* 指向该a问津系统超级块的指针 */
	...
	struct hlist_node	i_hash;	   /* 散列表，用户快速查找inode */
...
struct super_block {
	...
	/* 包含该具体文件系统的块设备标识符，例如:对于/dev/hda1, 其设备标识符为0x301 */
	...
	unsigned long		s_magic;	/* 魔数，即该具体文件系统区别于其它文件系统的一个标志 */
